...
namespace Sce.Atf.Drawing
{
    ...
    public static class AtfDrawingUtil
    {
        ...
        /// <param name="g">The ATF graphics object</param>
        ...
        public static void DrawExpander(this IAtfGraphics g, float x, float y, float size, IAtfBrush brush, bool expanded)
        {
        ...
        public static void DrawPin(int x, int y, bool pinned, bool toLeft, IAtfBrush pen, IAtfGraphics g)
        {
            if (toLeft)
        ...
        /// <param name="g">Graphics object</param>
        public static void DrawLeftPin(int x, int y, int size, IAtfBrush pen, bool pinned, IAtfGraphics g)
        {
        ...
        /// <param name="pinned">Whether or not expander should appear "expanded"</param>
        /// <param name="g">Graphics object</param>
        public static void DrawRightPin(int x, int y, int size, IAtfBrush pen, bool pinned, IAtfGraphics g)
        {
        ...
        /// <param name="size">Size of expander, in pixels</param>
        /// <param name="brush">Brush</param>
        public static void DrawLink(this IAtfGraphics g, float x, float y, float size, IAtfBrush brush)
        {
