...
namespace Sce.Atf.Drawing
{
    ...
    public interface IAtfTextFormat : IDisposable
    {
        ...
        AtfDrawingDrawTextOptions DrawTextOptions { get; set; }
        ...
        /// <returns>If the method succeeds, it returns AtfDrawingResult.Ok. 
        /// Otherwise, it throws an exception.</returns>
        AtfDrawingResult GetLineSpacing(
            out AtfDrawingLineSpacingMethod lineSpacingMethod,
            out float lineSpacing,
            out float baseline);

        /// <summary>
        /// Sets the line spacing</summary>
        /// <param name="lineSpacingMethod">Specifies how line height is being determined; see AtfDrawingLineSpacingMethod
        ...
        /// is 80 percent.</param>
        /// <returns>If the method succeeds, it returns AtfDrawingResult.OK. Otherwise, it throws an exception.</returns>
        /// <remarks>
        ...
        AtfDrawingResult SetLineSpacing(AtfDrawingLineSpacingMethod lineSpacingMethod, float lineSpacing, float baseline);
    }
    ...
    public enum AtfDrawingParagraphAlignment
    {
        /// <summary>
    ...
    public enum AtfDrawingReadingDirection
    {
        /// <summary>
    ...
    public enum AtfDrawingTextAlignment
    {
        /// <summary>
    ...
    public enum AtfDrawingWordWrapping
    {
        /// <summary>
    ...
    public enum AtfDrawingTrimmingGranularity
    {
        /// <summary>
    ...
    public struct AtfDrawingTrimming
    {
        /// <summary>
        ...
        /// the layout box</summary>
        public AtfDrawingTrimmingGranularity Granularity;
    }
    ...
    [Flags]
    public enum AtfDrawingDrawTextOptions
    {
        /// <summary>
    ...
    public enum AtfDrawingFontWeight
    {
        /// <summary>
    ...
    public enum AtfDrawingFontStyle
    {
        /// <summary>
    ...
    public enum AtfDrawingFontStretch
    {
        /// <summary>
