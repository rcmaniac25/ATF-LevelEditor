...
namespace Sce.Atf.Controls.Adaptable.Graphs
{
    ...
    public abstract class AtfDrawingGraphRenderer<TNode, TEdge, TEdgeRoute> : DiagramRenderer
        ...
        where TEdgeRoute : class, IEdgeRoute
    {
        ...
        public abstract void Draw(TNode node, DiagramDrawingStyle style, IAtfGraphics g);
        ...
        /// <param name="style">Diagram drawing style</param>
        /// <param name="g">IAtfGraphics object</param>
        public abstract void Draw(TEdge edge, DiagramDrawingStyle style, IAtfGraphics g);
        ...
        /// <param name="g">IAtfGraphics device</param>
        public void Draw(IGraph<TNode, TEdge, TEdgeRoute> graph, Selection<object> selection, IAtfGraphics g)
        {
        ...
        /// <param name="graph">Graph to render</param>
        /// <param name="g">IAtfGraphics device</param>
        public void Print(IGraph<TNode, TEdge, TEdgeRoute> graph, IAtfGraphics g)
        {
            try
            {
                IsPrinting = true;
        ...
        public virtual RectangleF GetBounds(TEdge edge, IAtfGraphics g)
        {
        ...
        /// <param name="g">IAtfGraphics object</param>
        /// <returns>Rectangle completely bounding the node in graph space</returns>
        public virtual RectangleF GetBounds(TNode node, IAtfGraphics g)
        {
            return node.Bounds;
        }
        ...
        public RectangleF GetBounds(IEnumerable<TNode> nodes, IAtfGraphics g)
        {
        ...
        public abstract GraphHitRecord<TNode, TEdge, TEdgeRoute> Pick(
            IGraph<TNode, TEdge, TEdgeRoute> graph, TEdge priorityEdge, PointF p, IAtfGraphics g);
        ...
        public virtual GraphHitRecord<TNode, TEdge, TEdgeRoute> Pick(
            IEnumerable<TNode> nodes, IEnumerable<TEdge> edges, TEdge priorityEdge, PointF p, IAtfGraphics g)
        {
        ...
        public virtual IEnumerable<object> Pick(
            IGraph<TNode, TEdge, TEdgeRoute> graph, RectangleF rect, IAtfGraphics g)
        {
